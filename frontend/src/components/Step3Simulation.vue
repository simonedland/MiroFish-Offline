  ...
  <div class="simulation-panel">
    ...
    <div class="control-bar">
      <div class="status-group">
        ...
        <div class="platform-status sms" :class="{ active: phase === 1, completed: phase === 2 }">
          <div class="platform-header">
            <svg class="platform-icon" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
            </svg>
            <span class="platform-name">SMS Network</span>
            <span v-if="phase === 2" class="status-badge">
          ...
          <div class="platform-stats">
            ...
            <span class="stat">
              ...
              <span class="stat-value mono">{{ phase === 0 ? 'Ready' : phase === 1 ? 'Running' : 'Done' }}</span>
            </span>
          </div>
        </div>
      </div>
...
const doStartSimulation = async () => {
  ...
  startError.value = null
  addLog('Starting SMS simulation...')
